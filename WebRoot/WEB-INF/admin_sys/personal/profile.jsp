...
<link href="${base}/res/assets/pages/css/invoice-2.min.css"
			...
			<div style="min-height:1022px" class="page-content">
				...
				<div class="page-bar">
					...
					<ul class="page-breadcrumb">
						<li><a href="${base}/admin/index.do">首页</a> <i class="fa fa-angle-right"></i>
						</li>
					...
					<div class="col-md-12">
						<div class="portlet box blue">
							...
							<div class="portlet-body form"  style="display: block;">
								<!-- BEGIN FORM-->
								<form action="o_profile.do" method="post" id="form_sample_1"
									...
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<span class="help-block">${user.username!?html} </span>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="password" name="origPwd" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3">新密码&nbsp;</label>
											<div class="col-md-9">
												<input type="password" placeholder="不修改请留空 " name="newPwd" id="newPwd" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3">确认密码&nbsp;</label>
											<div class="col-md-9">
												<input type="password" placeholder="不修改请留空 " name="newPwdAgain" class="form-control"> 
											</div>
										</div>
										<div class="form-group">
