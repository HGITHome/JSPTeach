								...
								<form id="tableForm" method="post">
									...
									<div class="table-scrollable">
										<table
											...
											<tbody>
												<#list pagination.list as chapter>
												<tr>
													<td>${chapter.id}</td>
												    <td>${chapter.name!}</td>
													<td>${chapter.priority!}</td>
													<td><a href="o_info.do?id=${chapter.id}"><i class="fa fa-eye">查看</i></a></td>
													<td>
													    <div class="btn-group">
															...
															<@cms_perm url="/chapter/section/v_list.do"> 
																<li><a href="section/v_list.do?chapterId=${chapter.id}"> <i
																		class="icon-docs"></i>查看子类</a></li> </@cms_perm>
																		
															 <@cms_perm url="/chapter/v_edit.do"> 
															 <li><a href="v_edit.do?id=${chapter.id}"> <i
																		class="icon-docs"></i>编辑 </a></li> </@cms_perm>		
																<@cms_perm url="/chapter/o_delete.do">
																<li><a href="o_delete.do?id=${chapter.id}" onclick="if(!confirm('确定删除？')) {return false;}"> <i
									...
									<@p.pagination value=pagination;chapter,i,has_next>
									</@p.pagination>
								</form>
							</div>
