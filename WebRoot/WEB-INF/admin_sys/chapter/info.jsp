        ...
        <div style="min-height:1022px" class="page-content">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    <li><a href="v_list.do">章列表</a> <i class="fa fa-angle-right"></i>
                    </li>
                    <li><span>章详情</span></li>
                </ul>
            </div>
                ...
                <div class="portlet box purple">
                    ...
                    <div class="portlet-body">
                        <div class="row static-info">
                            ...
                            <div class="col-md-4 value">${chapter.id}</div>
                        </div>
                        <div class="row static-info">
                            <div class="col-md-3 name">章名称:</div>
                            <div class="col-md-4 value">${chapter.name}</div>
                        </div>
                        <div class="row static-info">
                            <div class="col-md-3 name">章优先级:</div>
                            <div class="col-md-4 value">${chapter.priority}</div>
                        </div>
                        <div class="row static-info">
                            <div class="col-md-3 name">创建时间:</div>
                            <div class="col-md-4 value">${chapter.register_time?string('yyyy-MM-dd HH:mm:ss')}</div>
                        </div>
                        <div class="row static-info">
                            <div class="col-md-3 name">最后更新时间:</div>
                            <div class="col-md-4 value">${chapter.lastUpdate_time?string('yyyy-MM-dd HH:mm:ss')}</div>
                        </div>
