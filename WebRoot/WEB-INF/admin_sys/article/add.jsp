							            ...
							            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="margin-bottom-10">
                                                        ...
                                                        <select class="form-control input-small input-inline" id="section" name="section" data-style="btn-success">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="queryTitle" id="queryTitle" data-required="1" class="form-control" /> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="queryLabel" id="queryLabel" data-required="1" class="form-control" /> </div>
                                            </div>
                                      <div class="form-group">
                                        <span class="required"> * </span> 
                                        <textarea id="editor" name="content" style="width: 100%;height: 500px;" id="content"></textarea>
                                       </div>
