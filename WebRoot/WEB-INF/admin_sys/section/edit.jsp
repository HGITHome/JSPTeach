						...
						<div class="portlet box blue">
								...
								<div class="tools">
									<div class="dt-buttons">
										<a class="dt-button buttons-print btn white  btn-outline"
											href="v_list.do?chapterId=${section.chapter.id }" tabindex="0"><span>返回</span> </a>
									</div>
								</div>
							</div>
							<div class="portlet-body form" style="display: block;">
								...
								<form action="o_update.do" method="post" id="form_update"
									...
									<input type="hidden" name="chapterId" value="${section.chapter.id }" />
...
<script type="text/javascript">
  $(function(){
	  $('#queryPriority').val('${section.priority}');
  });
</script>
