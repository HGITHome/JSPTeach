...
public class Constants {
	 ...
	 * 数据库备份文本前缀
	 */
	public static String ONESQL_PREFIX="Data_BACKUP_";
	/**
	 * 防火墙配置文件
	 */
	 ...
	 * 文章文件路径
	 */
	public static String Article_FILEPATH = "D:\\file\\";
	
	/**
	 * 公告文件路径
	 */
	public static String NOTICE_FILEPATH = "D:\\file\\notice\\";
	
	public static String APP_ENCRYPTION_KEY = "IAASIDuioponuYBIUNLIK123ikoIO";
	public static String ENCRYPTION_KEY = "ASDHOjhudhaos23asdihoh80";
}
